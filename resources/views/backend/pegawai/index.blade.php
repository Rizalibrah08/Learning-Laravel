...
@section('title', 'Payroll Pegawai')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Payroll Pegawai</h4>
                    ...
                    @forelse($emp as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('emp_delete', $row->id_emp) }}" method="POST" class="d-inline" onsubmit="return confrim('Yakin ingin apus data ini?')">
                                    @csrf
                                    @method('DELETE')
