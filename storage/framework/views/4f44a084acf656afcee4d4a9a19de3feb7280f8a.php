                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="<?php echo e(route('emp_delete', $row->id_emp)); ?>" method="POST" class="d-inline" onsubmit="return confrim('Yakin ingin apus data ini?')">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.dashboard.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rijal\belajar_laravel\resources\views/backend/employees/index.blade.php ENDPATH**/ ?>