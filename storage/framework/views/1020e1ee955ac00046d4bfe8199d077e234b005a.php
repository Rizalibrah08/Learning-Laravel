...
<body class="bg-light">
        ...
        <div class="row">
            ...
            <aside class="col-12 col-md-3 col-lg-2 bg-white border-end shadow-sm p-3 min-vh-100">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?php echo e(route('emp')); ?>" class="nav-link text-dark">Pegawai</a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="<?php echo e(route('jbt')); ?>" class="nav-link text-dark">Jabatan</a>
                    </li>
                    <li class="nav-item mb-2">
    ...
    <footer class="bg-white border-top text-center py-3 mt-4 text-muted small">
        &copy; <?php echo e(date('Y')); ?> My Dashboard • All rights reserved
    </footer>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\rijal\Smester5\PWL\belajar_laravel\resources\views/backend/dashboard/index.blade.php ENDPATH**/ ?>