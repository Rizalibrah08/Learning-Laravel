...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <td>
                <?php if($row->img): ?>
                <img src="<?php echo e(asset('images/' . $row->img)); ?>" alt="foto <?php echo e($row->nama); ?>" width="60" height="60" class="rounded-circle border">
                <?php else: ?>
                <span class="text-mute">Tidak ada</span>
                <?php endif; ?>
            </td>
...
<?php echo $__env->make('backend.dashboard.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rijal ibrahim\HUAAA\LARAVEL ACUH\resources\views/backend/employees/index.blade.php ENDPATH**/ ?>